...
http_archive(
    ...
    url = "https://github.com/bazelbuild/rules_python/archive/2b1d6beb4d5d8f59d629597e30e9aa519182d9a9.zip",
)
...
http_archive(
    ...
    urls = [
        ...
        "https://github.wuyanzheshui.workers.dev/bazelbuild/rules_proto/archive/11bf7c25e666dd7ddacbcd4d4c4a9de7a25175f8.tar.gz",
    ],
)
